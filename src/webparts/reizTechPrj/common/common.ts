...
export const timeProxyCall = async (context: WebPartContext, fullUrl: string) => {
    try {

        const response = await context.spHttpClient.get(fullUrl, SPHttpClient.configurations.v1, {
            headers: {
